...
func (x *fastReflection_MarketAddTicketPayload) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sge.legacy.market.MarketAddTicketPayload.uid":
		return x.Uid != ""
	case "sge.legacy.market.MarketAddTicketPayload.start_ts":
		return x.StartTs != uint64(0)
	case "sge.legacy.market.MarketAddTicketPayload.end_ts":
		return x.EndTs != uint64(0)
	case "sge.legacy.market.MarketAddTicketPayload.odds":
		return len(x.Odds) != 0
	case "sge.legacy.market.MarketAddTicketPayload.status":
		return x.Status != 0
	case "sge.legacy.market.MarketAddTicketPayload.meta":
		return x.Meta != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.market.MarketAddTicketPayload"))
		}
		panic(fmt.Errorf("message sge.legacy.market.MarketAddTicketPayload does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MarketAddTicketPayload) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sge.legacy.market.MarketAddTicketPayload does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MarketAddTicketPayload) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "sge.legacy.market.MarketAddTicketPayload.uid":
		panic(fmt.Errorf("field uid of message sge.legacy.market.MarketAddTicketPayload is not mutable"))
	case "sge.legacy.market.MarketAddTicketPayload.start_ts":
		panic(fmt.Errorf("field start_ts of message sge.legacy.market.MarketAddTicketPayload is not mutable"))
	case "sge.legacy.market.MarketAddTicketPayload.end_ts":
		panic(fmt.Errorf("field end_ts of message sge.legacy.market.MarketAddTicketPayload is not mutable"))
	case "sge.legacy.market.MarketAddTicketPayload.status":
		panic(fmt.Errorf("field status of message sge.legacy.market.MarketAddTicketPayload is not mutable"))
	case "sge.legacy.market.MarketAddTicketPayload.meta":
		panic(fmt.Errorf("field meta of message sge.legacy.market.MarketAddTicketPayload is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.market.MarketAddTicketPayload"))
		}
...
func (x *fastReflection_MarketAddTicketPayload) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sge.legacy.market.MarketAddTicketPayload", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_MarketUpdateTicketPayload) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sge.legacy.market.MarketUpdateTicketPayload.uid":
		return x.Uid != ""
	case "sge.legacy.market.MarketUpdateTicketPayload.start_ts":
		return x.StartTs != uint64(0)
	case "sge.legacy.market.MarketUpdateTicketPayload.end_ts":
		return x.EndTs != uint64(0)
	case "sge.legacy.market.MarketUpdateTicketPayload.status":
		return x.Status != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.market.MarketUpdateTicketPayload"))
		}
		panic(fmt.Errorf("message sge.legacy.market.MarketUpdateTicketPayload does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MarketUpdateTicketPayload) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sge.legacy.market.MarketUpdateTicketPayload does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MarketUpdateTicketPayload) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sge.legacy.market.MarketUpdateTicketPayload.uid":
		panic(fmt.Errorf("field uid of message sge.legacy.market.MarketUpdateTicketPayload is not mutable"))
	case "sge.legacy.market.MarketUpdateTicketPayload.start_ts":
		panic(fmt.Errorf("field start_ts of message sge.legacy.market.MarketUpdateTicketPayload is not mutable"))
	case "sge.legacy.market.MarketUpdateTicketPayload.end_ts":
		panic(fmt.Errorf("field end_ts of message sge.legacy.market.MarketUpdateTicketPayload is not mutable"))
	case "sge.legacy.market.MarketUpdateTicketPayload.status":
		panic(fmt.Errorf("field status of message sge.legacy.market.MarketUpdateTicketPayload is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.market.MarketUpdateTicketPayload"))
		}
...
func (x *fastReflection_MarketUpdateTicketPayload) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sge.legacy.market.MarketUpdateTicketPayload", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_MarketResolutionTicketPayload) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sge.legacy.market.MarketResolutionTicketPayload.uid":
		return x.Uid != ""
	case "sge.legacy.market.MarketResolutionTicketPayload.resolution_ts":
		return x.ResolutionTs != uint64(0)
	case "sge.legacy.market.MarketResolutionTicketPayload.winner_odds_uids":
		return len(x.WinnerOddsUids) != 0
	case "sge.legacy.market.MarketResolutionTicketPayload.status":
		return x.Status != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.market.MarketResolutionTicketPayload"))
		}
		panic(fmt.Errorf("message sge.legacy.market.MarketResolutionTicketPayload does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MarketResolutionTicketPayload) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sge.legacy.market.MarketResolutionTicketPayload does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MarketResolutionTicketPayload) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "sge.legacy.market.MarketResolutionTicketPayload.winner_odds_uids":
		...
		return protoreflect.ValueOfList(value)
	case "sge.legacy.market.MarketResolutionTicketPayload.uid":
		panic(fmt.Errorf("field uid of message sge.legacy.market.MarketResolutionTicketPayload is not mutable"))
	case "sge.legacy.market.MarketResolutionTicketPayload.resolution_ts":
		panic(fmt.Errorf("field resolution_ts of message sge.legacy.market.MarketResolutionTicketPayload is not mutable"))
	case "sge.legacy.market.MarketResolutionTicketPayload.status":
		panic(fmt.Errorf("field status of message sge.legacy.market.MarketResolutionTicketPayload is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.market.MarketResolutionTicketPayload"))
		}
...
func (x *fastReflection_MarketResolutionTicketPayload) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sge.legacy.market.MarketResolutionTicketPayload", d.FullName()))
	}
	panic("unreachable")
}
...
var file_sge_legacy_market_v1beta_ticket_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x79, 0x2e, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f,
	...
	,
	...
	,
	...
	0x72, 0x6b, 0x65, 0x74, 0x42, 0x0b, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x74,
	...
	0x61, 0x70, 0x69, 0x2f, 0x73, 0x67, 0x65, 0x2f, 0x6c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x2f, 0x6d,
	0x61, 0x72, 0x6b, 0x65, 0x74, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0xa2, 0x02, 0x03, 0x53,
	0x4c, 0x4d, 0xaa, 0x02, 0x11, 0x53, 0x67, 0x65, 0x2e, 0x4c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x2e,
	0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0xca, 0x02, 0x11, 0x53, 0x67, 0x65, 0x5c, 0x4c, 0x65, 0x67,
	0x61, 0x63, 0x79, 0x5c, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0xe2, 0x02, 0x1d, 0x53, 0x67, 0x65,
	0x5c, 0x4c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x5c, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x5c, 0x47,
	0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x13, 0x53, 0x67, 0x65,
...
var file_sge_legacy_market_v1beta_ticket_proto_goTypes = []interface{}{
	(*MarketAddTicketPayload)(nil),        // 0: sge.legacy.market.MarketAddTicketPayload
	(*MarketUpdateTicketPayload)(nil),     // 1: sge.legacy.market.MarketUpdateTicketPayload
	(*MarketResolutionTicketPayload)(nil), // 2: sge.legacy.market.MarketResolutionTicketPayload
	(*Odds)(nil),                          // 3: sge.legacy.market.Odds
	(MarketStatus)(0),                     // 4: sge.legacy.market.MarketStatus
}
var file_sge_legacy_market_v1beta_ticket_proto_depIdxs = []int32{
	3, // 0: sge.legacy.market.MarketAddTicketPayload.odds:type_name -> sge.legacy.market.Odds
	4, // 1: sge.legacy.market.MarketAddTicketPayload.status:type_name -> sge.legacy.market.MarketStatus
	4, // 2: sge.legacy.market.MarketUpdateTicketPayload.status:type_name -> sge.legacy.market.MarketStatus
	4, // 3: sge.legacy.market.MarketResolutionTicketPayload.status:type_name -> sge.legacy.market.MarketStatus
