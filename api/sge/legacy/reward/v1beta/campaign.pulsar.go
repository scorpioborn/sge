...
func (x *fastReflection_Campaign) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sge.legacy.reward.Campaign.creator":
		return x.Creator != ""
	case "sge.legacy.reward.Campaign.uid":
		return x.Uid != ""
	case "sge.legacy.reward.Campaign.promoter":
		return x.Promoter != ""
	case "sge.legacy.reward.Campaign.start_ts":
		return x.StartTs != uint64(0)
	case "sge.legacy.reward.Campaign.end_ts":
		return x.EndTs != uint64(0)
	case "sge.legacy.reward.Campaign.reward_category":
		return x.RewardCategory != 0
	case "sge.legacy.reward.Campaign.reward_type":
		return x.RewardType != 0
	case "sge.legacy.reward.Campaign.reward_amount_type":
		return x.RewardAmountType != 0
	case "sge.legacy.reward.Campaign.reward_amount":
		return x.RewardAmount != nil
	case "sge.legacy.reward.Campaign.pool":
		return x.Pool != nil
	case "sge.legacy.reward.Campaign.is_active":
		return x.IsActive != false
	case "sge.legacy.reward.Campaign.meta":
		return x.Meta != ""
	case "sge.legacy.reward.Campaign.cap_count":
		return x.CapCount != uint64(0)
	case "sge.legacy.reward.Campaign.constraints":
		return x.Constraints != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.reward.Campaign"))
		}
		panic(fmt.Errorf("message sge.legacy.reward.Campaign does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Campaign) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sge.legacy.reward.Campaign does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Campaign) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "sge.legacy.reward.Campaign.creator":
		panic(fmt.Errorf("field creator of message sge.legacy.reward.Campaign is not mutable"))
	case "sge.legacy.reward.Campaign.uid":
		panic(fmt.Errorf("field uid of message sge.legacy.reward.Campaign is not mutable"))
	case "sge.legacy.reward.Campaign.promoter":
		panic(fmt.Errorf("field promoter of message sge.legacy.reward.Campaign is not mutable"))
	case "sge.legacy.reward.Campaign.start_ts":
		panic(fmt.Errorf("field start_ts of message sge.legacy.reward.Campaign is not mutable"))
	case "sge.legacy.reward.Campaign.end_ts":
		panic(fmt.Errorf("field end_ts of message sge.legacy.reward.Campaign is not mutable"))
	case "sge.legacy.reward.Campaign.reward_category":
		panic(fmt.Errorf("field reward_category of message sge.legacy.reward.Campaign is not mutable"))
	case "sge.legacy.reward.Campaign.reward_type":
		panic(fmt.Errorf("field reward_type of message sge.legacy.reward.Campaign is not mutable"))
	case "sge.legacy.reward.Campaign.reward_amount_type":
		panic(fmt.Errorf("field reward_amount_type of message sge.legacy.reward.Campaign is not mutable"))
	case "sge.legacy.reward.Campaign.is_active":
		panic(fmt.Errorf("field is_active of message sge.legacy.reward.Campaign is not mutable"))
	case "sge.legacy.reward.Campaign.meta":
		panic(fmt.Errorf("field meta of message sge.legacy.reward.Campaign is not mutable"))
	case "sge.legacy.reward.Campaign.cap_count":
		panic(fmt.Errorf("field cap_count of message sge.legacy.reward.Campaign is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.reward.Campaign"))
		}
...
func (x *fastReflection_Campaign) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sge.legacy.reward.Campaign", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_Pool) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sge.legacy.reward.Pool.total":
		return x.Total != ""
	case "sge.legacy.reward.Pool.spent":
		return x.Spent != ""
	case "sge.legacy.reward.Pool.withdrawn":
		return x.Withdrawn != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.reward.Pool"))
		}
		panic(fmt.Errorf("message sge.legacy.reward.Pool does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Pool) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sge.legacy.reward.Pool does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Pool) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sge.legacy.reward.Pool.total":
		panic(fmt.Errorf("field total of message sge.legacy.reward.Pool is not mutable"))
	case "sge.legacy.reward.Pool.spent":
		panic(fmt.Errorf("field spent of message sge.legacy.reward.Pool is not mutable"))
	case "sge.legacy.reward.Pool.withdrawn":
		panic(fmt.Errorf("field withdrawn of message sge.legacy.reward.Pool is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.reward.Pool"))
		}
...
func (x *fastReflection_Pool) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sge.legacy.reward.Pool", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_CampaignConstraints) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sge.legacy.reward.CampaignConstraints.max_bet_amount":
		return x.MaxBetAmount != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.reward.CampaignConstraints"))
		}
		panic(fmt.Errorf("message sge.legacy.reward.CampaignConstraints does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CampaignConstraints) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sge.legacy.reward.CampaignConstraints does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CampaignConstraints) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sge.legacy.reward.CampaignConstraints.max_bet_amount":
		panic(fmt.Errorf("field max_bet_amount of message sge.legacy.reward.CampaignConstraints is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.reward.CampaignConstraints"))
		}
...
func (x *fastReflection_CampaignConstraints) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sge.legacy.reward.CampaignConstraints", d.FullName()))
	}
	panic("unreachable")
}
...
type Campaign struct {
	...
	RewardCategory RewardCategory `protobuf:"varint,6,opt,name=reward_category,json=rewardCategory,proto3,enum=sge.legacy.reward.RewardCategory" json:"reward_category,omitempty"`
	// reward_type is the type of reward.
	RewardType RewardType `protobuf:"varint,7,opt,name=reward_type,json=rewardType,proto3,enum=sge.legacy.reward.RewardType" json:"reward_type,omitempty"`
	// amount_type is the type of reward amount.
	RewardAmountType RewardAmountType `protobuf:"varint,8,opt,name=reward_amount_type,json=rewardAmountType,proto3,enum=sge.legacy.reward.RewardAmountType" json:"reward_amount_type,omitempty"`
...
var file_sge_legacy_reward_v1beta_campaign_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x73, 0x67, 0x65, 0x2e, 0x6c,
	0x65, 0x67, 0x61, 0x63, 0x79, 0x2e, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x1a, 0x19, 0x63, 0x6f,
	...
	0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x25, 0x73,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe8, 0x05, 0x0a, 0x08, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67,
	...
	,
	...
	,
	...
	0x64, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0xa2, 0x02, 0x03, 0x53, 0x4c, 0x52, 0xaa, 0x02,
	0x11, 0x53, 0x67, 0x65, 0x2e, 0x4c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x2e, 0x52, 0x65, 0x77, 0x61,
	0x72, 0x64, 0xca, 0x02, 0x11, 0x53, 0x67, 0x65, 0x5c, 0x4c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x5c,
	0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0xe2, 0x02, 0x1d, 0x53, 0x67, 0x65, 0x5c, 0x4c, 0x65, 0x67,
	0x61, 0x63, 0x79, 0x5c, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65,
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x13, 0x53, 0x67, 0x65, 0x3a, 0x3a, 0x4c, 0x65,
	0x67, 0x61, 0x63, 0x79, 0x3a, 0x3a, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_sge_legacy_reward_v1beta_campaign_proto_goTypes = []interface{}{
	(*Campaign)(nil),            // 0: sge.legacy.reward.Campaign
	(*Pool)(nil),                // 1: sge.legacy.reward.Pool
	(*CampaignConstraints)(nil), // 2: sge.legacy.reward.CampaignConstraints
	(RewardCategory)(0),         // 3: sge.legacy.reward.RewardCategory
	(RewardType)(0),             // 4: sge.legacy.reward.RewardType
	(RewardAmountType)(0),       // 5: sge.legacy.reward.RewardAmountType
	(*RewardAmount)(nil),        // 6: sge.legacy.reward.RewardAmount
}
var file_sge_legacy_reward_v1beta_campaign_proto_depIdxs = []int32{
	3, // 0: sge.legacy.reward.Campaign.reward_category:type_name -> sge.legacy.reward.RewardCategory
	4, // 1: sge.legacy.reward.Campaign.reward_type:type_name -> sge.legacy.reward.RewardType
	5, // 2: sge.legacy.reward.Campaign.reward_amount_type:type_name -> sge.legacy.reward.RewardAmountType
	6, // 3: sge.legacy.reward.Campaign.reward_amount:type_name -> sge.legacy.reward.RewardAmount
	1, // 4: sge.legacy.reward.Campaign.pool:type_name -> sge.legacy.reward.Pool
	2, // 5: sge.legacy.reward.Campaign.constraints:type_name -> sge.legacy.reward.CampaignConstraints
